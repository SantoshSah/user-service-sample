...
import (
	...
	userservicesvr "github.com/SantoshSah/user-service-sample/gen/grpc/user_service/server"
...
func handleGRPCServer(ctx context.Context, u *url.URL, userServiceEndpoints *userservice.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
	...
	{
		userServiceServer = userservicesvr.New(userServiceEndpoints, nil)
	}
	...
	user_servicepb.RegisterUserServiceServer(srv, userServiceServer)
